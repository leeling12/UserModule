        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PositionRefId = table.Column<int>(type: "int", nullable: false),
                    TeamRefId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.PositionRefId,
                        principalTable: "Positions",
                        principalColumn: "PositionId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Users_Statuses_StatusRefId",
                        column: x => x.StatusRefId,
                        principalTable: "Statuses",
                        principalColumn: "StatusId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Users_Teams_TeamRefId",
                        column: x => x.TeamRefId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_StatusRefId",
                table: "Users",
                column: "StatusRefId");

            migrationBuilder.CreateIndex(
                name: "IX_Users_TeamRefId",
                table: "Users",
                column: "TeamRefId");
        }
